...
getTechnologieById(id: number) {
    ...
    return this.httpClient.get<any>(this.link+"/Technologies/getTechnologie/"+id, {headers:headers_object}).pipe(map(param=>{ 
...
getProjects():Observable<Project[]>{
    ...
    return this.httpClient.get<any[]>(this.link+"/projects/getProjects",{headers:headers_object}).pipe(map(param=>{
        let projects:Project[]=[];
...
getPersonalProjects():Observable<Project[]>{
    ...
    return this.httpClient.get<any[]>(this.link+"/projects/getProjectsByType/personal",{headers:headers_object}).pipe(map(param=>{
        let projects:Project[]=[];
...
addProject(project:Project){
    var headers_object = new HttpHeaders().set('Content-Type', 'application/json')
    .set('Authorization', `Bearer `+this.user.token);
    return this.httpClient.post<number>(this.link+"/projects/addProject",project,{headers:headers_object})
}
...
deleteProject(project:Project){
    ...
    var headers_object = new HttpHeaders().set('Content-Type', 'application/json')
    .set('Authorization', `Bearer `+this.user.token);
    return this.httpClient.delete(this.link+"/projects/deleteProject",{headers:headers_object,body:project})
}
uploadFile(formData:FormData): Observable<any> {
    var headers_object = new HttpHeaders().set('Accept', 'application/json')
    .set('Authorization', `Bearer `+this.user.token);
    return this.httpClient.post<any>(this.link+"/upload",formData,{headers:headers_object})
}
}